            ...
            <div class="modal-content">
                <form action="editData.php" method="POST">
                    ...
                    <div class="modal-body"> 
                        <input type="hidden" name="old_kecamatan" id="oldKecamatan">
                        <div class="mb-3">
    ...
    <script>
        ...
        function confirmDelete(kecamatan) {
            Swal.fire({
                ...
                text: 'Data kecamatan ' + decodeURIComponent(kecamatan) + ' akan dihapus!',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    // Jika pengguna mengonfirmasi penghapusan, alihkan ke URL delete
        ...
        function openEditModal(kecamatan, longitude, latitude, luas, jmlPenduduk) {
            ...
            document.getElementById('oldKecamatan').value = kecamatan; 
        }

        // Cek status dari URL (jika ada) untuk menampilkan pesan notifikasi
        ...
        if (status === 'success') {
            Swal.fire({
                icon: 'success',
                title: 'Berhasil!',
                text: 'Data kecamatan berhasil diperbarui.',
            });
        ...
        const statusDelete = urlParams.get('statusDelete');
